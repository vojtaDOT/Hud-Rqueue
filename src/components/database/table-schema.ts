...
export const TABLE_SCHEMAS: TableSchema[] = [
    ...
    },
    {
        ...
        columns: [
            ...
            { name: 'source_id', label: 'Source ID', type: 'bigint', nullable: true },
            { name: 'document_id', label: 'Document ID', type: 'bigint', nullable: true },
            { name: 'source_url_id', label: 'Source URL ID', type: 'bigint', nullable: true },
            { name: 'item_key', label: 'Item Key', type: 'text', searchable: true },
            { name: 'item_label', label: 'Item Label', type: 'text', searchable: true, nullable: true, truncate: 80 },
            { name: 'stage', label: 'Stage', type: 'text', searchable: true },
            { name: 'item_type', label: 'Item Type', type: 'text', searchable: true },
            { name: 'status', label: 'Pipeline Status', type: 'text', searchable: true },
            ...
            { name: 'job_id', label: 'Job ID', type: 'text', nullable: true },
            { name: 'step_order', label: 'Step Order', type: 'integer', nullable: true },
            { name: 'context_json', label: 'Context', type: 'jsonb', nullable: true, hidden: true },
            ...
            { name: 'first_seen_at', label: 'First Seen', type: 'timestamp', nullable: true },
            { name: 'last_seen_at', label: 'Last Seen', type: 'timestamp', nullable: true },
    ...
    },
    {
        ...
        columns: [
            ...
            { name: 'active_stage', label: 'Active Stage', type: 'text', nullable: true },
            { name: 'error_message', label: 'Error', type: 'text', nullable: true, truncate: 80 },
